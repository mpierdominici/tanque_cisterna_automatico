...
//*********Pines***********
#define PIN_BOMBA RELE_CH1 
#define PIN_REPOSO ANALOG_CH2 
#define PIN_BOMBEANDO ANALOG_CH3
...
void onEnterReposo(void);
void onExitReposo(void);
void onSinAgua(void);
void onExitSinAgua(void);
void onBombeando(void);
void onExitBombeando(void);
void onNoNet(void);
void onExitNoNet(void);
...
const char MqttUser[]="cisternaBox2";
const char MqttPassword[]="1234";
const char MqttClientID[]="cisterna2";
